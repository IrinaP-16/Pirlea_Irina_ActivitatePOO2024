...
int main() {
	...
	*/
	...
	//ofstream poo("fisier1.txt",ios::app); //este creat fisierul in care vrem sa scriem
	//irina << m; //apelam operatorul << pt fisiere
	//

	//Magazin m1("Galati", 4, 90.6, 2004);
	//poo << m1;
	//poo.close();
